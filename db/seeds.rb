...
musicfile1 = open(Rails.root.join('app', 'assets', 'tracks', 'Serge Devant - This Moment (Original Mix).wav'))
musicfile2 = open(Rails.root.join('app', 'assets', 'tracks', '01 Esente (Original Mix).mp3'))
musicfile3 = open(Rails.root.join('app', 'assets', 'tracks', '01 Trimming.mp3'))
...
musicfile7 = open(Rails.root.join('app', 'assets', 'tracks', 'Audiojack - Spirit (Original Mix).wav'))
musicfile8 = open(Rails.root.join('app', 'assets', 'tracks', 'Fatima Yamaha - Whats a Girl to Do (Original Mix)120bpm.mp3'))
...
musicfile11 = open(Rails.root.join('app', 'assets', 'tracks', 'Kermesse - Nostalgia (Mira & Chris Schwarzwalder Remix)84bpm.mp3'))
musicfile12 = open(Rails.root.join('app', 'assets', 'tracks', 'La Feinte N.mp3'))
musicfile6 = open(Rails.root.join('app', 'assets', 'tracks', 'Maxi Dance.mp3'))
musicfile13 = open(Rails.root.join('app', 'assets', 'tracks', 'Montat.mp3'))
musicfile14 = open(Rails.root.join('app', 'assets', 'tracks', 'NINZE & OKAXY - Apollo (Original Mix)110bpm.mp3'))
musicfile15 = open(Rails.root.join('app', 'assets', 'tracks', 'Padap - Bruno Ponsanto Remix.mp3'))
musicfile16 = open(Rails.root.join('app', 'assets', 'tracks', 'Rodrigo Gallardo - El Abuelo Feat. Fernando Milagros (Dandara Remix)105bpm.mp3'))
musicfile17 = open(Rails.root.join('app', 'assets', 'tracks', 'Sabo - Open Up the Channel (Original Mix)99bpm.mp3'))
musicfile18 = open(Rails.root.join('app', 'assets', 'tracks', 'Serge Devant - This Moment (Original Mix).wav'))
musicfile19 = open(Rails.root.join('app', 'assets', 'tracks', 'Suspecte.mp3'))
